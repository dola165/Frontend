        ...
        <section className="theme-surface theme-border rounded-2xl border px-5 py-4 shadow-lg dark:shadow-[0_12px_28px_rgba(0,0,0,0.2)]">
            ...
            {!isAuthenticated ? (
                ...
                <div className="mt-5 grid gap-4 lg:grid-cols-2">
                    <div className="rounded-2xl border border-slate-300 bg-slate-50 px-4 py-4 dark:border-slate-700 dark:bg-slate-900/50">
                        <div className="flex items-center gap-2">
                            <Sparkles className="h-4 w-4 text-emerald-500" />
                            <p className="text-[10px] font-black uppercase tracking-[0.18em] text-slate-500 dark:text-slate-400">Player Route</p>
                        </div>
                        <h4 className="mt-4 text-base font-black uppercase tracking-tight text-slate-900 dark:text-white">{playerHeadline}</h4>
                        <p className="mt-2 text-sm font-medium text-slate-600 dark:text-slate-300">{playerDescription}</p>
                        ...
                        {playerJoinPolicy === 'APPLICATION_REQUIRED' && (
                            <textarea
                                ...
                                className="theme-surface-muted theme-border mt-4 w-full rounded-xl border px-4 py-3 text-sm font-medium text-slate-900 outline-none focus:border-emerald-500 dark:text-white"
                            />
                        )}
                    ...
                    <div className="rounded-2xl border border-slate-300 bg-slate-50 px-4 py-4 dark:border-slate-700 dark:bg-slate-900/50">
                        <div className="flex items-center gap-2">
                            ...
                            <p className="text-[10px] font-black uppercase tracking-[0.18em] text-slate-500 dark:text-slate-400">Coach Route</p>
                        </div>
                        <h4 className="mt-4 text-base font-black uppercase tracking-tight text-slate-900 dark:text-white">Apply as coach</h4>
                        <p className="mt-2 text-sm font-medium text-slate-600 dark:text-slate-300">
                        ...
                        <button
                            ...
                            className="mt-4 inline-flex items-center gap-2 rounded-xl border border-slate-900 bg-slate-200 px-5 py-3 text-[11px] font-black uppercase tracking-[0.18em] text-slate-900 shadow-[4px_4px_0px_0px_#020617] transition-all hover:bg-slate-300 active:translate-y-0.5 active:shadow-none disabled:cursor-not-allowed disabled:opacity-70 dark:bg-slate-800 dark:text-white dark:hover:bg-slate-700"
                        >
