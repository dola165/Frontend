...
export const InvitesTab = ({
    overview, searchQuery, searchPage, searchResults, searchLoading,
    ...
    <div className="space-y-6">
        <div className="space-y-4">
            ...
            {searchQuery.trim().length < 2 ? (
                ...
                <div className="rounded-md border border-[var(--fc-border)] bg-[var(--fc-card-bg)] overflow-hidden">
                    <DataTable columns={['User', 'Details', 'Action']}>
        ...
        <div className="space-y-4">
            ...
            {overview && overview.pendingInvitations.length === 0 ? (
                <EmptyState message="No pending invitations." />
            ) : overview && (
                <div className="rounded-md border border-[var(--fc-border)] bg-[var(--fc-card-bg)] overflow-hidden">
                    <DataTable columns={['User', 'Role', 'Status', 'Sent', '']}>
