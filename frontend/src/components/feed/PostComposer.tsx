...
export const PostComposer = ({clubId, authorName = "You", onPostCreated}: PostComposerProps) => {
    ...
    return (
        <div
            className="bg-white dark:bg-[#1e293b] border-2 border-slate-300 dark:border-black rounded-lg p-4 shadow-lg dark:shadow-[0_10px_30px_rgba(0,0,0,0.6)] mb-6">
            ...
            {previewUrl && (
                <div
                    className="relative mb-3 ml-13 rounded-lg overflow-hidden border border-slate-200 dark:border-slate-700 w-fit">
            ...
            <div
                className="flex items-center justify-between pt-3 border-t border-slate-200 dark:border-slate-800 ml-13">
